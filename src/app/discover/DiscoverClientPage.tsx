...
export default function DiscoverClientPage() { // Renamed function
  ...
  const searchGutendex = async (termToSearch: string | null, searchType: 'topic' | 'search' | 'popular') => {
    ...
    try {
      ...
      console.log("[DiscoverClientPage] Fetching Gutendex URL:", apiUrl); // Updated log source

      const response = await fetch(apiUrl);
      if (!response.ok) {
        const errorText = await response.text();
        console.error("[DiscoverClientPage] Gutendex API Error Response:", errorText); // Updated log source
