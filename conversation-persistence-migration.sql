-- Conversation Persistence Migration for Recaplio AI Assistant (Lio)
...
CREATE TABLE IF NOT EXISTS ai_conversation_sessions (
    ...
    -- Ensure only one active session per user per book
...
-- Add conversation-specific learning data
DO $$ 
BEGIN
